...
export type RemoteDashboardRegistryEntry = {
...
export const remoteDashboardConfigs = [
  {
    key: 'aawm-tap',
    ...
    importModule: () => import('aawm-tap-dashboard/module'),
  },
  {
    key: 'aegis',
    ...
    importModule: () => import('aegis-dashboard/module'),
  },
  {
    key: 'sluice',
    moduleId: 'sluice',
    ...
    importModule: () => import('sluice/module'),
  },
...
export function remoteDashboardHref(
  config: Pick<RemoteDashboardRegistryEntry, 'basePath'>,
  routePath: string
) {
